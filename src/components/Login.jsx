...
const Login = () => {
  return (
	...
	<div
		...
		<div>
			<h1 className="text-white font-bold text-4xl font-sans">Go Weather</h1>
			<p className="text-white mt-1">Plan Your Day with Accurate Weather Forecasts</p>
			...
			<p className="text-sm font-normal text-gray-600 mb-7">Welcome Back</p>
					...
					<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<div className="flex items-center border-2 py-2 px-3 rounded-2xl">
							...
							<button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Register acount</button>
